<div class="pins index">
	...
	<tr>
		...
		<td><?php echo h($pin['Pin']['latitude']); ?>&nbsp;</td>
		<td><?php echo h($pin['Pin']['longitude']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $pin['Pin']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $pin['Pin']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $pin['Pin']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $pin['Pin']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
